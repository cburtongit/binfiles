...
if echo "$FLIST" | grep -i ".jpeg\|.png\|.jpg" &>/dev/null; then
	...
	# For example, if you want a 200 by 200 window on the bottom right hand corner of a 200x200+1400+700 screen: "250x250+1670+830"
	setsid feh -g 200x200+1400+700 -x --zoom fill "$ART" &
else
	killall -q feh
	exit
fi